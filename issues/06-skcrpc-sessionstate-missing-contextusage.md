# 06 — `skc_rpc` `SessionState` drops `contextUsage`

- **Severity:** Medium
- **Scope:** `python/skc-rpc/src/skc_rpc/protocol.py:681-699` (`SessionState`), `:1181-1214` (`parse_session_state`)
- **Surface:** `skc_rpc` typed client
...
This drift was only observed because the client was driven against real skc
