...
- **Scope:** `packages/coding-agent/src/skc-runtime/ralplan-runtime.ts:235-246` (`persistActiveRunId` no-op guard)
...
`active: false` (e.g. after a prior `skc state ralplan clear` that set
