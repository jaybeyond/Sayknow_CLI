"""Client half of the roboskc ↔ gh-proxy channel.
...
routing clone/fetch/push through the proxy too — roboskc never holds the PAT.
...
from roboskc.git_ops import GitCommandError, HeadDriftError, PushResult
...
class GitHubProxyClient:
    """HMAC-signed REST client speaking to a `roboskc.proxy.server` instance.
