"""Shared HMAC signing/verification for the roboskc ↔ gh-proxy channel.
...
# Headers on every roboskc→gh-proxy request.
HEADER_TIMESTAMP = "X-Roboskc-Timestamp"  # unix seconds, integer string
HEADER_SIGNATURE = "X-Roboskc-Sig"  # hex-encoded HMAC-SHA256
