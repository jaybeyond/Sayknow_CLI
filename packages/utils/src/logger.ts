/**
 * Centralized logger for sayknow-cli.
 *
 * Default: rotating `~/.skc/logs/skc.<DATE>.log`, no console output (writing
 ...
 *
 * Each entry includes `process.pid` so concurrent skc instances stay
 * traceable.
 */
