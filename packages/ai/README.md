...
```bash
npm install @sayknow-cli/ai
```

## Quick Start

```typescript
import { z, getModel, stream, complete, Context, Tool } from "@sayknow-cli/ai";
...
```typescript
import { z, Tool } from "@sayknow-cli/ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@sayknow-cli/ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@sayknow-cli/ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@sayknow-cli/ai";
...
```typescript
import { getModel, stream } from "@sayknow-cli/ai";
...
```typescript
import { getProviders, getModels, getModel } from "@sayknow-cli/ai";
...
```typescript
import { Model, stream } from "@sayknow-cli/ai";
...
```typescript
import { getModel, complete, Context } from "@sayknow-cli/ai";
...
```typescript
import { Context, getModel, complete } from "@sayknow-cli/ai";
...
```typescript
import { getEnvApiKey } from "@sayknow-cli/ai";
...
```bash
bunx @sayknow-cli/ai login              # interactive provider selection
bunx @sayknow-cli/ai login anthropic    # login to specific provider
bunx @sayknow-cli/ai login vllm         # store vLLM API key (or placeholder for local no-auth)
bunx @sayknow-cli/ai login xai          # sign in with xAI/Grok OAuth
bunx @sayknow-cli/ai list               # list available providers
```
...
```typescript
import { loginGitHubCopilot } from "@sayknow-cli/ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@sayknow-cli/ai";
import * as fs from "node:fs";
