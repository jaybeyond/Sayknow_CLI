...
import type { AssistantMessage, Model, ToolResultMessage, UserMessage } from "@sayknow-cli/ai/types";
 ...
 * carries `tool_use_id`. As a workaround, SKC must include `id` (aliased to
