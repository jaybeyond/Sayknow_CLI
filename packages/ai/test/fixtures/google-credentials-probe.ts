...
import { resolveAdcCredentialsPathForTest } from "@sayknow-cli/ai/providers/google-auth";
import { resolveVertexApiKeyForTest } from "@sayknow-cli/ai/providers/google-vertex";
