...
const originalSkcCacheRetention = Bun.env.SKC_CACHE_RETENTION;
const originalPiCacheRetention = Bun.env.PI_CACHE_RETENTION;

afterEach(() => {
	if (originalSkcCacheRetention === undefined) {
		delete Bun.env.SKC_CACHE_RETENTION;
	} else {
		Bun.env.SKC_CACHE_RETENTION = originalSkcCacheRetention;
	}
...
describe("resolveCacheRetention", () => {
	it("uses documented SKC_CACHE_RETENTION for long retention", () => {
		Bun.env.SKC_CACHE_RETENTION = "long";
		delete Bun.env.PI_CACHE_RETENTION;
	...
	it("prefers SKC_CACHE_RETENTION over legacy PI_CACHE_RETENTION", () => {
		Bun.env.SKC_CACHE_RETENTION = "short";
		Bun.env.PI_CACHE_RETENTION = "long";
