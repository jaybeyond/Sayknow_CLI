/**
 * Test helper for resolving API keys from ~/.skc/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@sayknow-cli/ai/utils/oauth";
import type { OAuthCredentials, OAuthProvider } from "@sayknow-cli/ai/utils/oauth/types";
import { $flag, getAgentDir, isEnoent } from "@sayknow-cli/utils";
...
/**
 * Resolve API key for a provider from ~/.skc/agent/testauth.db
 *
