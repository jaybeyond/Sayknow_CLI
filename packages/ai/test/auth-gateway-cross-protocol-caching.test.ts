 ...
 *     → openai-responses parser → skc Context
...
const MODEL = Bun.env.SKC_E2E_ANTHROPIC_MODEL ?? "claude-sonnet-4-5";
...
the skc auth-gateway's cross-protocol prompt-caching pipeline. The request
