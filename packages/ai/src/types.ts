...
export interface ModelRequestTransform {
	/** Named request-shaping preset. `openai-proxy` removes OpenAI SDK telemetry headers and uses a generic Sayknow-CLI User-Agent. */
...
export interface Model<TApi extends Api = any> {
	 ...
	 * provider client. The `baseUrl` must point at an `skc auth-gateway`
