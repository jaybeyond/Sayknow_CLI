...
async function createClient(
	...
	if (model.provider === "openrouter") {
		...
		headers["User-Agent"] = `Sayknow-CLI/${packageJson.version}`;
		headers["HTTP-Referer"] = "https://github.com/jaybeyond/Sayknow_CLI/";
		headers["X-OpenRouter-Title"] = "Sayknow-CLI";
	...
	headers = applyOpenAIRequestTransformHeaders(headers, model.requestTransform, `Sayknow-CLI/${packageJson.version}`);
