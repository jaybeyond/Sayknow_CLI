...
- **Theme Support**: Components accept theme interfaces for customizable styling (the coding-agent bundles a red-octopus crustacean theme built on these interfaces)
...
```typescript
import { TUI, Text, Editor, ProcessTerminal } from "@sayknow-cli/tui";
...
```typescript
import { CombinedAutocompleteProvider } from "@sayknow-cli/tui";
...
```typescript
import { Ellipsis, visibleWidth, truncateToWidth, wrapTextWithAnsi } from "@sayknow-cli/tui";
...
```typescript
import { isEnter, isEscape, isArrowUp, isArrowDown, isCtrlC, isTab, isBackspace } from "@sayknow-cli/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@sayknow-cli/tui";
import type { Component } from "@sayknow-cli/tui";
