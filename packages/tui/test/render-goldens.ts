...
// be re-sorted below the @sayknow-cli/tui imports.)
...
import { ImageProtocol } from "@sayknow-cli/tui/terminal-capabilities";
...
export async function captureRenderGolden(fixture: GoldenFixture): Promise<RenderGoldenCapture> {
	...
	let terminalCapabilities: typeof import("@sayknow-cli/tui/terminal-capabilities") | null = null;
	...
	try {
		...
		terminalCapabilities =
			fixture.imageProtocol === undefined ? null : await import("@sayknow-cli/tui/terminal-capabilities");
