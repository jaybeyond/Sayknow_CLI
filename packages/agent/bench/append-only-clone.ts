...
import { AppendOnlyContextManager, StablePrefix } from "@sayknow-cli/agent-core/append-only-context";
import type { AgentContext } from "@sayknow-cli/agent-core/types";
import type { Message, Tool } from "@sayknow-cli/ai";

const WARMUP_ITERATIONS = 10;
const MEASURE_ITERATIONS = 80;
const MESSAGE_COUNT = 1_000;
const PACKAGE_NAME = "@sayknow-cli/agent-core";
