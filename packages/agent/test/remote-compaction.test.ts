...
import { buildOpenAiNativeHistory, requestOpenAiRemoteCompaction } from "@sayknow-cli/agent-core/compaction/openai";
import type { AssistantMessage, Model, ToolResultMessage } from "@sayknow-cli/ai/types";
