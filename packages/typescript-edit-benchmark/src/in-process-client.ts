 ...
 */
import type { AgentEvent, AgentMessage, ResolvedThinkingLevel, ThinkingLevel } from "@sayknow-cli/agent-core";
import type { Model } from "@sayknow-cli/ai";
import type { AgentSession, AgentSessionEvent, AuthStorage, SessionStats } from "@sayknow-cli/coding-agent";
import {
...
export async function discoverSharedInfra(options: DiscoverSharedInfraOptions = {}): Promise<SharedInfra> {
	const { ModelRegistry: MR } = await import("@sayknow-cli/coding-agent");
