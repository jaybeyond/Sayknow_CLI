...
import type { AgentMessage, ResolvedThinkingLevel, ThinkingLevel } from "@sayknow-cli/agent-core";
import type { Model } from "@sayknow-cli/ai";
import { computeLineHash, formatSessionDumpText, RpcClient } from "@sayknow-cli/coding-agent";
...
const CLI_PATH = Bun.fileURLToPath(import.meta.resolve("@sayknow-cli/coding-agent/cli"));
...
interface BenchmarkClient {
	start(): Promise<void>;
	setThinkingLevel(level: import("@sayknow-cli/agent-core").ResolvedThinkingLevel): Promise<void>;
