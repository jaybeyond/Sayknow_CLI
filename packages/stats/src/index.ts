...
import { formatDuration, formatNumber, formatPercent } from "@sayknow-cli/utils";
...
async function main(): Promise<void> {
	...
	if (values.help) {
		console.log(`
skc-stats - AI Usage Statistics Dashboard
...
Examples:
  skc-stats              # Start dashboard server
  skc-stats --json       # Print stats as JSON
  skc-stats --port 8080  # Start on custom port
  skc-stats --sync       # Sync and show summary
`);
		return;
	}
