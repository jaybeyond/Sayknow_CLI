 ...
 * - ~/.skc/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.skc/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.skc/agent/extensions/ or .skc/extensions/
