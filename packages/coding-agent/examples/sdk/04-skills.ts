 ...
 */
import { createAgentSession, discoverSkills, SessionManager, type Skill } from "@sayknow-cli/coding-agent";

// Discover all skills from cwd/.skc/skills, ~/.skc/agent/skills, etc.
