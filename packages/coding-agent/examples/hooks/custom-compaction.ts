 ...
 *
 * Usage:
 *   skc --hook examples/hooks/custom-compaction.ts
 */
import { complete, getModel } from "@sayknow-cli/ai";
import type { HookAPI } from "@sayknow-cli/coding-agent";
import { convertToLlm, serializeConversation } from "@sayknow-cli/coding-agent";
