 ...
 *
 * Usage:
 * 1. Copy this file to ~/.skc/agent/extensions/ (legacy: ~/.pi/agent/extensions/) or your project's .skc/extensions/
 * 2. Use /tools to open the tool selector
 */
import type { ExtensionAPI, ExtensionContext } from "@sayknow-cli/coding-agent";
import { getSettingsListTheme } from "@sayknow-cli/coding-agent";
import { Container, type SettingItem, SettingsList } from "@sayknow-cli/tui";
