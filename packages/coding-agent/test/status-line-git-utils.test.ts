...
} from "@sayknow-cli/coding-agent/modes/components/status-line/git-utils";

describe("parseGitHubRepo", () => {
	test("parses HTTPS URL", () => {
		expect(parseGitHubRepo("https://github.com/jaybeyond/Sayknow_CLI.git")).toBe("jaybeyond/Sayknow_CLI");
	});

	test("parses HTTPS URL without .git suffix", () => {
		expect(parseGitHubRepo("https://github.com/jaybeyond/Sayknow_CLI")).toBe("jaybeyond/Sayknow_CLI");
	});

	test("parses SSH scp-style URL", () => {
		expect(parseGitHubRepo("git@github.com:loftiskg/sayknow-cli.git")).toBe("loftiskg/sayknow-cli");
	});

	test("parses SSH scp-style URL without .git suffix", () => {
		expect(parseGitHubRepo("git@github.com:loftiskg/sayknow-cli")).toBe("loftiskg/sayknow-cli");
	});
