...
describe("parseGitHubRepo", () => {
	test("parses HTTPS URL", () => {
		expect(parseGitHubRepo("https://github.com/jaybeyond/sayknow-cli.git")).toBe("jaybeyond/sayknow-cli");
	});

	test("parses HTTPS URL without .git suffix", () => {
		expect(parseGitHubRepo("https://github.com/jaybeyond/sayknow-cli")).toBe("jaybeyond/sayknow-cli");
	});
