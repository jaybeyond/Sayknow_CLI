...
import { classifyHookSelectorBellEvent, ringTerminalBell } from "@sayknow-cli/coding-agent/modes/utils/terminal-bell";

beforeEach(async () => {
	resetSettingsForTest();
	const tempDir = fs.mkdtempSync(path.join(os.tmpdir(), "skc-terminal-bell-"));
