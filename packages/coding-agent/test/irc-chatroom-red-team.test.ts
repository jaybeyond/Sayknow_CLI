...
} from "@sayknow-cli/coding-agent/modes/components/irc-sidebar";
...
import type { InteractiveModeContext, IrcArrivalSnapshot } from "@sayknow-cli/coding-agent/modes/types";
import {
	formatIrcMessageBlock,
	type ParsedIrcMessage,
	parseIrcMessage,
} from "@sayknow-cli/coding-agent/modes/utils/irc-message";
import { UiHelpers } from "@sayknow-cli/coding-agent/modes/utils/ui-helpers";
import { type Component, Container, TUI, visibleWidth } from "@sayknow-cli/tui";
import { VirtualTerminal } from "../../tui/test/virtual-terminal";

const artifactDirectory = path.join(os.tmpdir(), `skc-irc-chatroom-red-team-${process.pid}`);
