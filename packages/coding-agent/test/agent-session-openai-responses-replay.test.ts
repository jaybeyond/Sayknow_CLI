...
import type { AssistantMessage, Message, ProviderPayload, ProviderSessionState, Usage } from "@sayknow-cli/ai/types";
import { createOpenAIResponsesHistoryPayload } from "@sayknow-cli/ai/utils";
import * as asyncModule from "@sayknow-cli/coding-agent/async";
import * as settingsModule from "@sayknow-cli/coding-agent/config/settings";
import type { CreateAgentSessionResult } from "@sayknow-cli/coding-agent/sdk";
import * as sdkModule from "@sayknow-cli/coding-agent/sdk";
import type { AgentSession, ForkContextSeed } from "@sayknow-cli/coding-agent/session/agent-session";
import type { AuthStorage } from "@sayknow-cli/coding-agent/session/auth-storage";
import {
	type SessionEntry,
	SessionManager,
	type SessionMessageEntry,
} from "@sayknow-cli/coding-agent/session/session-manager";
import * as taskModule from "@sayknow-cli/coding-agent/task";
import * as agentsModule from "@sayknow-cli/coding-agent/task/agents";
import * as discoveryModule from "@sayknow-cli/coding-agent/task/discovery";
import * as eventBusModule from "@sayknow-cli/coding-agent/utils/event-bus";
...
async function createSessionHarness(
	...
	const [{ createAgentSession }, { Settings }, { AuthStorage }] = await Promise.all([
		import("@sayknow-cli/coding-agent/sdk"),
		import("@sayknow-cli/coding-agent/config/settings"),
		import("@sayknow-cli/coding-agent/session/auth-storage"),
	]);
