...
import * as contextManager from "@sayknow-cli/coding-agent/eval/js/context-manager";
import * as pyExecutor from "@sayknow-cli/coding-agent/eval/py/executor";
...
import * as tabSupervisor from "@sayknow-cli/coding-agent/tools/browser/tab-supervisor";
...
describe("AgentSession.disposeChildSubprocesses (#698 signal teardown)", () => {
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@skc-signal-teardown-");
