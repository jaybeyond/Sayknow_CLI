...
import { getThemeByName, initTheme, setThemeInstance, theme } from "@sayknow-cli/coding-agent/modes/theme/theme";
...
import { Container, ImageProtocol, TERMINAL, type TUI } from "@sayknow-cli/tui";

const SIXEL_START = "\x1bPq";
const SIXEL_END = "\x1b\\";
const SIXEL_PLACEHOLDER = "[SIXEL image hidden while IRC sidebar is visible]";
const artifactDir = path.join(os.tmpdir(), `skc-irc-red-team-artifacts-${process.pid}`);
