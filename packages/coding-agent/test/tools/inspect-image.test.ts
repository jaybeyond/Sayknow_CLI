...
import type { completeSimple, Model } from "@sayknow-cli/ai";
...
import { InspectImageTool } from "@sayknow-cli/coding-agent/tools/inspect-image";
import { inspectImageToolRenderer } from "@sayknow-cli/coding-agent/tools/inspect-image-renderer";
...
describe("InspectImageTool", () => {
	...
	beforeEach(() => {
		testDir = fs.mkdtempSync(path.join(os.tmpdir(), "skc-inspect-image-"));
	});
