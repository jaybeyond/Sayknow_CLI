...
import { handleAur } from "@sayknow-cli/coding-agent/web/scrapers/aur";
import { handleBrew } from "@sayknow-cli/coding-agent/web/scrapers/brew";
import { handleMaven } from "@sayknow-cli/coding-agent/web/scrapers/maven";
import { handleNuGet } from "@sayknow-cli/coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@sayknow-cli/coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@sayknow-cli/coding-agent/web/scrapers/rubygems";
