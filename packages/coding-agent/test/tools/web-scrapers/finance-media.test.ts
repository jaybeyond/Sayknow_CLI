...
import { handleArtifactHub } from "@sayknow-cli/coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@sayknow-cli/coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@sayknow-cli/coding-agent/web/scrapers/discogs";
