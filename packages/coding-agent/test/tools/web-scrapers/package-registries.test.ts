...
import { handleCratesIo } from "@sayknow-cli/coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@sayknow-cli/coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@sayknow-cli/coding-agent/web/scrapers/hex";
import { handleNpm } from "@sayknow-cli/coding-agent/web/scrapers/npm";
import { handlePubDev } from "@sayknow-cli/coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@sayknow-cli/coding-agent/web/scrapers/pypi";
