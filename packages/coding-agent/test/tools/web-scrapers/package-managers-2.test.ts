...
import { handleChocolatey } from "@sayknow-cli/coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@sayknow-cli/coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@sayknow-cli/coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@sayknow-cli/coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@sayknow-cli/coding-agent/web/scrapers/repology";
import { handleTerraform } from "@sayknow-cli/coding-agent/web/scrapers/terraform";
