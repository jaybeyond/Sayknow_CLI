...
import { handleArxiv } from "@sayknow-cli/coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@sayknow-cli/coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@sayknow-cli/coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@sayknow-cli/coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@sayknow-cli/coding-agent/web/scrapers/types";
