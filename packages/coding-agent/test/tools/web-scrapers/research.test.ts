...
import { handleBiorxiv } from "@sayknow-cli/coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@sayknow-cli/coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@sayknow-cli/coding-agent/web/scrapers/wikidata";
