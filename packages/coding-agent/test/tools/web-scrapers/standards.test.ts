...
import { handleCheatSh } from "@sayknow-cli/coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@sayknow-cli/coding-agent/web/scrapers/rfc";
import { handleTldr } from "@sayknow-cli/coding-agent/web/scrapers/tldr";
