...
import type { CustomToolContext } from "@sayknow-cli/coding-agent/extensibility/custom-tools";
import type { ReadonlySessionManager } from "@sayknow-cli/coding-agent/session/session-manager";
import {
	getImageGenToolsWithRegistry,
	imageGenTool,
	setPreferredImageProvider,
} from "@sayknow-cli/coding-agent/tools/image-gen";
