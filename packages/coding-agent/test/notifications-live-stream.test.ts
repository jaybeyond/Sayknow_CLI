...
//    SKC_NOTIFICATIONS_TURN_MAX raises it so full turns reach split-capable
...
test("SKC_NOTIFICATIONS_TURN_MAX raises the finalized cap for full-turn delivery", async () => {
	const text = await finalizedTextFor({ SKC_NOTIFICATIONS: "1", SKC_NOTIFICATIONS_TURN_MAX: "40000" });
...
test("non-finite SKC_NOTIFICATIONS_TURN_MAX falls back to the 3500 default", async () => {
