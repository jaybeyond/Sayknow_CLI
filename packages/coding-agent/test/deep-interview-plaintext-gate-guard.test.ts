...
import { detectDeepInterviewPlaintextAskLeak } from "@sayknow-cli/coding-agent/deep-interview/plaintext-gate-guard";
...
Selected: Yes, crystallize`;
	...
	it("does not flag ordinary CLI or documentation help containing an Options section", () => {
		const text = `Usage: skc deep-interview [prompt]
