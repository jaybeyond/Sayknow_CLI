...
import { Agent, AgentBusyError, type AgentTool } from "@sayknow-cli/agent-core";
import { type AssistantMessage, getBundledModel, type Message, type ToolCall } from "@sayknow-cli/ai";
...
import { TtsrManager } from "@sayknow-cli/coding-agent/export/ttsr";
import type { ExtensionRunner } from "@sayknow-cli/coding-agent/extensibility/extensions/runner";
...
describe("AgentSession concurrent prompt guard", () => {
	...
	// already processing` from skc-rpc clients (roboskc triage reminder path).
