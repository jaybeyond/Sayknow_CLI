...
} from "@sayknow-cli/coding-agent/modes/rpc/rpc-types";
import { approvalGate, executionGate } from "@sayknow-cli/coding-agent/modes/shared/agent-wire/approval-gate";
import {
	dispatchRpcCommand,
	type RpcCommandDispatchContext,
	type RpcUnattendedControlPlane,
} from "@sayknow-cli/coding-agent/modes/shared/agent-wire/command-dispatch";
import { isRpcCommand } from "@sayknow-cli/coding-agent/modes/shared/agent-wire/command-validation";
import { questionToGate } from "@sayknow-cli/coding-agent/modes/shared/agent-wire/deep-interview-gate";
import { UnattendedRunController } from "@sayknow-cli/coding-agent/modes/shared/agent-wire/unattended-run-controller";
import {
	MemoryGateStore,
	WorkflowGateBroker,
