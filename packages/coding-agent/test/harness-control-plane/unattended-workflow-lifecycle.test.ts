...
import {
	...
	decodeExecution,
	executionGate,
} from "@sayknow-cli/coding-agent/modes/shared/agent-wire/approval-gate";
import {
	type AskGateQuestion,
	gateAnswerToResult,
	questionToGate,
} from "@sayknow-cli/coding-agent/modes/shared/agent-wire/deep-interview-gate";
import { UnattendedAuditLog } from "@sayknow-cli/coding-agent/modes/shared/agent-wire/unattended-audit";
import {
	ActionDeniedError,
	UnattendedRunController,
} from "@sayknow-cli/coding-agent/modes/shared/agent-wire/unattended-run-controller";
import {
	FileGateStore,
	type GateAuditEvent,
	WorkflowGateBroker,
