...
import { SelectList } from "@sayknow-cli/tui/components/select-list";
import { SettingsList } from "@sayknow-cli/tui/components/settings-list";
import {
	setKeybindings,
	TUI_KEYBINDINGS,
	KeybindingsManager as TuiKeybindingsManager,
} from "@sayknow-cli/tui/keybindings";
...
beforeEach(async () => {
	root = await fs.mkdtemp(path.join(os.tmpdir(), "skc-ux-adversarial-"));
