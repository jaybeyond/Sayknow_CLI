...
import type { RpcUnattendedActionClass, RpcUnattendedDeclaration } from "@sayknow-cli/coding-agent/modes/rpc/rpc-types";
import { classifyBashAction } from "@sayknow-cli/coding-agent/modes/shared/agent-wire/unattended-action-policy";
import {
	ActionDeniedError,
