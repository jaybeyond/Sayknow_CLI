...
import { clearCache, readFile } from "@sayknow-cli/coding-agent/capability/fs";
...
import { getProjectPathCandidates } from "@sayknow-cli/coding-agent/discovery/agents";
import {
...
describe("agents provider project-level discovery", () => {
	...
	describe("skills", () => {
		...
		test("project walk-up skips home directory (no repo root)", async () => {
			// Regression for https://github.com/jaybeyond/Sayknow_CLI/issues/1116:
