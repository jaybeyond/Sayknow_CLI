...
} from "@sayknow-cli/coding-agent/skc-runtime/deep-interview-runtime";
import {
...
async function tempDir(): Promise<string> {
	const dir = await fs.mkdtemp(path.join(os.tmpdir(), "skc-di-hud-sync-"));
	tempRoots.push(dir);
	return dir;
}
...
describe("deep-interview skc state write preserves recorder rounds", () => {
