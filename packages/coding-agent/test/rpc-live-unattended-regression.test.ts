...
import type { RpcUnattendedDeclaration } from "@sayknow-cli/coding-agent/modes/rpc/rpc-types";
import { approvalGate } from "@sayknow-cli/coding-agent/modes/shared/agent-wire/approval-gate";
import { dispatchRpcCommand } from "@sayknow-cli/coding-agent/modes/shared/agent-wire/command-dispatch";
