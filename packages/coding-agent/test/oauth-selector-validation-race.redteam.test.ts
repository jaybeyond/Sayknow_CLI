...
import { clearProviderAuthHealth, getProviderAuthHealth } from "@sayknow-cli/coding-agent/config/provider-auth-health";
...
function installTestTheme(): void {
	if (!testTheme) throw new Error("Failed to load red-octopus test theme");
