...
import { getWelcomeTranscriptReservedRows } from "@sayknow-cli/coding-agent/modes/interactive-mode";
import {
	IRC_OBSERVATION_LEDGER_MAX_RECORDS,
	IRC_OBSERVATION_LEDGER_MAX_SEEN_IDENTITIES,
	IrcObservationLedger,
} from "@sayknow-cli/coding-agent/modes/irc-observation-ledger";
...
import { Container, Text } from "@sayknow-cli/tui";
