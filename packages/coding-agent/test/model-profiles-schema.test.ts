...
import { resolveProfileBindings } from "@sayknow-cli/coding-agent/config/model-profiles";
import { ModelsConfigSchema } from "@sayknow-cli/coding-agent/config/models-config-schema";
...
describe("model profile schema", () => {
	...
	// Runtime defaulting treats any non-"long" SKC_CACHE_RETENTION value as short;
