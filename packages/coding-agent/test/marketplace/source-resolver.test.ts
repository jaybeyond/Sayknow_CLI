...
import type { MarketplacePluginEntry } from "@sayknow-cli/coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@sayknow-cli/coding-agent/extensibility/plugins/marketplace";
...
describe("resolvePluginSource", () => {
	...
	beforeEach(() => {
		tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "skc-src-res-test-"));
	});
