...
import { BlobStore, EphemeralBlobStore, externalizeImageDataSync } from "@sayknow-cli/coding-agent/session/blob-store";
...
function makeTempDir(): string {
	const dir = fs.mkdtempSync(path.join(os.tmpdir(), "skc-resident-cache-"));
	tempDirs.push(dir);
	return dir;
}
