 ...
 * brush spawn). This test pulls the fix end-to-end through the SKC coding
 * agent stack:
 *
 *   AgentSession.prompt
 *     → Agent.prompt (real)
 ...
 * SIGTTIN/SIGTTOU the SKC host process.
 */
...
import { createMockModel, type MockResponse } from "@sayknow-cli/ai/providers/mock";
