...
import { applyDisabledExtensionsToState } from "@sayknow-cli/coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@sayknow-cli/coding-agent/modes/components/extensions/types";
