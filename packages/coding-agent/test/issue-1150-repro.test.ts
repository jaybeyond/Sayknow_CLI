...
/**
 * Regression for https://github.com/jaybeyond/Sayknow_CLI/issues/1150
 *
 * In v15.1.3 `skc stats` crashed in the published Linux/macOS/Windows
 ...
 * the tab worker entry. Runtime coverage lives in `skc --smoke-test`,
