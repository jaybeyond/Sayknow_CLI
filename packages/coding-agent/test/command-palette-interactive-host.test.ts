...
import { KeybindingsManager } from "@sayknow-cli/coding-agent/config/keybindings";
import { resetSettingsForTest, Settings } from "@sayknow-cli/coding-agent/config/settings";
import type { LoadedCustomCommand } from "@sayknow-cli/coding-agent/extensibility/custom-commands";
import {
	ExtensionRunner,
	loadExtensions,
	type RegisteredCommand,
} from "@sayknow-cli/coding-agent/extensibility/extensions";
import type { Skill } from "@sayknow-cli/coding-agent/extensibility/skills";
import { CommandPaletteComponent } from "@sayknow-cli/coding-agent/modes/components/command-palette";
import { InteractiveMode } from "@sayknow-cli/coding-agent/modes/interactive-mode";
...
import { HistoryStorage } from "@sayknow-cli/coding-agent/session/history-storage";
import { SessionManager } from "@sayknow-cli/coding-agent/session/session-manager";
import * as titleGenerator from "@sayknow-cli/coding-agent/utils/title-generator";
import { setKeybindings } from "@sayknow-cli/tui";
...
async function createHost(): Promise<InteractivePaletteHost> {
	const partialHost: PartialInteractivePaletteHost = {
		tempDir: TempDir.createSync("@skc-command-palette-host-"),
	};
	try {
