...
const ralplanReReviewContractPatterns = [
	...
	/skc\.ralplan\.maxReviewPassesPerLane/u,
	/Default: \*\*1\*\* Architect pass and \*\*1\*\* Critic pass per opener iteration\./u,
	/project `\.skc\/settings\.json` overrides user settings; the value is an integer \*\*1\.\.10\*\* registered in the public settings schema\./u,
