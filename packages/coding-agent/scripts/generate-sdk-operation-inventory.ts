...
const inventoryPath = process.env.SKC_SDK_OPERATION_INVENTORY
	? path.resolve(process.env.SKC_SDK_OPERATION_INVENTORY)
...
async function scanSeams(): Promise<SourceSeam[]> {
	const root = process.env.SKC_SDK_SEAM_SCAN_ROOT;
	if (root) {
