...
const CANONICAL_COMMAND =
	"bun packages/coding-agent/scripts/capture-platform-shortcut-labels-showcase.ts --output .skc/qa/platform-shortcut-labels";
	...
	const metadata = json({
		...
		terminal: {
			...
			font_rendering_assumptions:
				"Embedded red-octopus truecolor theme; HTML uses a monospace terminal fallback stack.",
			wrapping_policy:
