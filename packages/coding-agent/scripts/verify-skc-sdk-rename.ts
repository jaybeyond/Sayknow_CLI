...
const repoRoot = process.env.SKC_SDK_RENAME_SCAN_ROOT
	? path.resolve(process.env.SKC_SDK_RENAME_SCAN_ROOT)
	: path.resolve(import.meta.dir, "..", "..", "..");
const scannerPath = "packages/coding-agent/scripts/verify-skc-sdk-rename.ts";
...
const forbidden = [
	{ label: "skc-notifications", pattern: /\bskc-notifications\b/i },
	{ label: "skc_notifications", pattern: /\bskc_notifications\b/ },
	{ label: "@sayknow-cli/notifications", pattern: /@sayknow-cli[/_-]notifications\b/i },
...
process.stdout.write("SKC SDK rename verification passed.\n");
