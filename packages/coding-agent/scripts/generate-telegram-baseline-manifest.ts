...
const testDirectory = process.env.SKC_TELEGRAM_BASELINE_TEST_DIR
	? path.resolve(process.env.SKC_TELEGRAM_BASELINE_TEST_DIR)
	: path.join(repoRoot, "packages", "coding-agent", "test");
const manifestPath = process.env.SKC_TELEGRAM_BASELINE_MANIFEST
	? path.resolve(process.env.SKC_TELEGRAM_BASELINE_MANIFEST)
