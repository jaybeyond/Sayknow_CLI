 ...
 */
import type { AgentToolResult, AgentToolUpdateCallback } from "@sayknow-cli/agent-core";
import type { CompactionResult } from "@sayknow-cli/agent-core/compaction";
import type { Model, Static, TSchema } from "@sayknow-cli/ai";
...
export interface CustomToolAPI {
	...
	logger: typeof import("@sayknow-cli/utils").logger;
