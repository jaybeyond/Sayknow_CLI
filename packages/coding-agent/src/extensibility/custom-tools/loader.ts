 ...
 *
 * Dependencies (the zod-backed typebox shim and sayknow-cli) are injected via the
...
export class CustomToolLoader {
	...
	constructor(
		pi: typeof import("@sayknow-cli/coding-agent"),
		cwd: string,
 ...
 * 2. Installed plugins (~/.skc/plugins/node_modules/*)
...
export async function discoverAndLoadCustomTools(
	...
	// 2. Plugin tools: ~/.skc/plugins/node_modules/*/
