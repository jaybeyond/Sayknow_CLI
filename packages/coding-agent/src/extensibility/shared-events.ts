...
import type { CompactionPreparation, CompactionResult } from "@sayknow-cli/agent-core/compaction";
import type { ImageContent, TextContent, ToolResultMessage } from "@sayknow-cli/ai";
