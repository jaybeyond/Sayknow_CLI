...
import { getPluginsLockfile, getPluginsNodeModules, getPluginsPackageJson, isEnoent } from "@sayknow-cli/utils";
...
/**
 * Load project-local plugin overrides (checks .skc and .pi directories).
 */
