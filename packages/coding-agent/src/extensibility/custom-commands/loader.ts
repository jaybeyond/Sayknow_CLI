...
import { getAgentDir, getProjectDir, isEnoent, logger } from "@sayknow-cli/utils";
...
/**
 * Load bundled commands (shipped with sayknow-cli).
 */
...
export async function loadCustomCommands(options: LoadCustomCommandsOptions = {}): Promise<CustomCommandsLoadResult> {
	...
	const sharedApi: CustomCommandAPI = {
		...
		typebox,
		zod,
		pi: await import("@sayknow-cli/coding-agent"),
	};
