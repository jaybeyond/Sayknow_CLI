...
import { SkcPluginLoadError, type SkcPluginMcpManifestEntry } from "./types";
...
function fail(message: string): never {
	throw new SkcPluginLoadError("security_policy", message);
}
...
export function assertStdioAllowed(entry: SkcPluginMcpManifestEntry, ctx: StdioPolicyContext): void {
 ...
 */
export function assertMcpInstallPolicy(entry: SkcPluginMcpManifestEntry, ctx: StdioPolicyContext): void {
