import { loadEffectiveSkcPluginRegistry } from "./registry";
...
/**
 * Observability for SKC plugin bundle surfaces, consumable by the extension
...
export interface PluginSurfaceRow {
	...
	sourceKind: SkcPluginRegistryEntry["source"]["kind"];
...
function rowsForEntry(entry: SkcPluginRegistryEntry, quarantinedIds: Map<string, string>): PluginSurfaceRow[] {
 ...
 */
export async function summarizeSkcPluginObservability(cwd: string): Promise<PluginObservabilitySummary> {
