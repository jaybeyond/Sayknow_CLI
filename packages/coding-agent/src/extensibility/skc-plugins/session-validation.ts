...
import type { SkcPluginLoadErrorCode, SkcPluginRegistryEntry } from "./types";
 ...
 * runtime_mismatch.
 */
export async function verifyEntryHashes(entry: SkcPluginRegistryEntry): Promise<SessionQuarantine | null> {
...
function activeSurfaceIds(entry: SkcPluginRegistryEntry): {
...
export function validateSessionBundles(
	...
	const active: SkcPluginRegistryEntry[] = [];
