/**
 * Map raw source MCP server entries onto SKC `MCPServerConfig`.
 *
...
/** Fields with no SKC equivalent: omitted-with-warning (named explicitly so the warning is precise). */
