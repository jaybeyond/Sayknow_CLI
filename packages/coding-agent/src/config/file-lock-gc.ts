...
import { getAgentDir, getConfigRootDir, isEnoent } from "@sayknow-cli/utils";
...
import { gcPidStatusLabel } from "../skc-runtime/gc-runtime";
...
// Global, env-aware SKC lock roots. Per the approved scope this covers the
// user config root, the agent dir (honors SKC_CODING_AGENT_DIR), and the
// configured receipt-spool dir — NOT the invocation cwd's project `.skc`.
