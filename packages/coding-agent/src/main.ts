...
import { isManagedOwnerSupervisorArgv, runManagedOwnerSupervisor } from "./skc-runtime/managed-owner-supervisor";
...
/**
 * Research-mode (RLM) preset hook. Lets `skc rlm` augment the session options
