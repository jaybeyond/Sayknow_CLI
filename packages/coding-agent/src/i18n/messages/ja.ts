...
export const ja: Partial<Record<MsgKey, string>> = {
	...
	"welcome.label.branch": "ブランチ",
	"welcome.label.commits": "コミット",
	"welcome.label.model": "モデル",
	"welcome.label.reasoning": "推論",
	"welcome.label.preset": "プリセット",
	"welcome.label.roles": "ロール",
	"welcome.label.tools": "ツール",
	"welcome.noGit": "git リポジトリではありません",
	"welcome.rolesInherit": "ロールは既定モデルに従う",
	"welcome.skills": "スキル",
	"welcome.rules": "ルール",
	"welcome.clean": "変更なし",
	"welcome.whatsNew": "新着",
	"welcome.readyPrompt": "次のプロンプトを待機中",
