...
export const ko: Partial<Record<MsgKey, string>> = {
	...
	"welcome.label.branch": "브랜치",
	"welcome.label.commits": "커밋",
	"welcome.label.model": "모델",
	"welcome.label.reasoning": "추론",
	"welcome.label.preset": "프리셋",
	"welcome.label.roles": "역할",
	"welcome.label.tools": "도구",
	"welcome.noGit": "git 저장소 아님",
	"welcome.rolesInherit": "역할은 기본 모델을 따름",
	"welcome.skills": "스킬",
	"welcome.rules": "규칙",
	"welcome.clean": "깨끗함",
	"welcome.whatsNew": "새 소식",
	"welcome.readyPrompt": "다음 프롬프트를 기다리는 중",
