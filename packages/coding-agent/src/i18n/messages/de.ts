...
export const de: Partial<Record<MsgKey, string>> = {
	...
	"welcome.label.branch": "Branch",
	"welcome.label.commits": "Commits",
	"welcome.label.model": "Modell",
	"welcome.label.reasoning": "Reasoning",
	"welcome.label.preset": "Preset",
	"welcome.label.roles": "Rollen",
	"welcome.label.tools": "Werkzeuge",
	"welcome.noGit": "kein Git-Repository",
	"welcome.rolesInherit": "Rollen folgen dem Standardmodell",
	"welcome.skills": "Skills",
	"welcome.rules": "Regeln",
	"welcome.clean": "sauber",
	"welcome.whatsNew": "Neu",
	"welcome.readyPrompt": "Bereit für den nächsten Prompt",
