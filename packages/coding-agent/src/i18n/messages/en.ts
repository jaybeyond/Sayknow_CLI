...
export const en = {
	...
	"welcome.label.tools": "tools",
	"welcome.noGit": "not a git repository",
	"welcome.rolesInherit": "roles follow the default model",
	"welcome.skills": "skills",
	"welcome.rules": "rules",
	"welcome.clean": "clean",
	"welcome.whatsNew": "What's new",
	"welcome.readyPrompt": "Ready for your next prompt",
