...
// the cursor/gemini/opencode/windsurf providers: SKC does not inherit MCP
// servers live from other hosts. MCP comes from SKC's own config (builtin,
// mcp-json), validated plugin bundles, or an explicit `skc mcp import <host>`.
import "./windsurf";
