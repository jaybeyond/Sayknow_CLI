/**
 * `skc migrate` — import MCP servers and skills from other coding agents.
 */
import * as os from "node:os";
import * as path from "node:path";
import { getAgentDir, getMCPConfigPath, getProjectAgentDir, getProjectDir } from "@sayknow-cli/utils";
