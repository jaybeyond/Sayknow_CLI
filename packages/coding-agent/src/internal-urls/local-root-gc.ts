...
import type { GcCollectResult, GcContext, GcError, GcRecord, GcStoreAdapter } from "../skc-runtime/gc-runtime";
...
const LOCAL_ROOT_PARENT = "skc-local";
...
/** Bound the scan so a pathological directory cannot stall `skc gc`. */
