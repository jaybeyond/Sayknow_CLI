/**
 * Internal URL router for internal protocols (agent://, artifact://, memory://, rule://, skc://, local://).
 *
...
import { SkcProtocolHandler } from "./skc-protocol";
...
export class InternalUrlRouter {
	...
	constructor() {
		this.register(new SkcProtocolHandler());
