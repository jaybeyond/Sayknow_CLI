/**
 * Install SKC defaults or optional feature dependencies.
 */
...
export default class Setup extends Command {
	static description = "Install SKC defaults or optional feature dependencies";
	...
	static flags = {
		...
		"session-command": Flags.string({ description: "Explicit SKC session command for Hermes to launch" }),
		"no-worktree": Flags.boolean({ description: "Disable default SKC --worktree isolation for Hermes sessions" }),
		"worktree-name": Flags.string({ description: "Named SKC --worktree branch for Hermes sessions" }),
