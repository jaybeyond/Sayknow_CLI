...
export default class Plugin extends Command {
	...
	static flags = {
		...
		user: Flags.boolean({ description: "Install SKC plugin bundle into the user root" }),
		project: Flags.boolean({ description: "Install SKC plugin bundle into the project root" }),
	};
