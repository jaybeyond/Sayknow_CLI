...
export default class MCP extends Command {
	...
	static examples = [
		...
		"skc mcp add docs --type http --url https://example.test/mcp --header Authorization=Bearer_TOKEN",
		"skc mcp list --json",
	...
	static flags = {
		project: Flags.boolean({ description: "Write/read project scope (./.skc/mcp.json) instead of user scope" }),
