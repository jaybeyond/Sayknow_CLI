 ...
 *
 * On interactive launch, if `gh` is authenticated and the SKC repo is not
 ...
 *
 * All state lives in a user-global file under the SKC config root and is updated
