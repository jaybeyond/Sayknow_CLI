...
import type { Message, TextContent } from "@sayknow-cli/ai";
...
const PLACEHOLDER_DOMAIN = "skc.secret-obfuscation.placeholder.v1\0";
const PLACEHOLDER_RE = /#SKC1_[A-Za-z0-9_-]{22}#/g;
