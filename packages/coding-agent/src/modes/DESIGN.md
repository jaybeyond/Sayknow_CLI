...
```sh
bun packages/coding-agent/scripts/capture-notifications-settings-showcase.ts --output .skc/qa/issue-2050-notifications
```
...
`.skc/qa/issue-2050-notifications/independent-review.json`. The reviewer must
