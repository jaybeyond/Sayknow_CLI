...
// Legacy custom-config alias only. Public presets must use `sayknow`.
const legacyPiSegment: StatusLineSegment = {
	id: "pi",
	render(_ctx) {
		return sayknowSegment.render(_ctx);
	},
};
