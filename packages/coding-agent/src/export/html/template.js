    (function() {
      ...
      const injectedParams =
        document.querySelector('meta[name="skc-url-params"]') ||
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta =
          document.querySelector('meta[name="skc-share-base-url"]') ||
      ...
      function renderHeader() {
        ...
        let html = `
          <div class="header">
            <div class="brand-kicker">sayknow-cli · red-octopus transcript</div>
            <h1>SKC Session Export: ${escapeHtml(header?.id || 'unknown')}</h1>
            <div class="help-bar">Ctrl+T toggle thinking · Ctrl+O toggle tools</div>
            <div class="header-info">
              <div class="info-item"><span class="info-label">Product:</span><span class="info-value">SKC / sayknow-cli</span></div>
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'skc-share:v1:sidebar-width';
