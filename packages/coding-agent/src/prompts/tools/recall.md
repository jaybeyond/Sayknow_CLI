Compatibility-only legacy Hindsight helper. This prompt is retained for backend/tool-call compatibility and is not part of the public sayknow-cli coding harness tool surface.
