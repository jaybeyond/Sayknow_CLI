 ...
 *
 * The Rust control ingress (crates/skc-sdk control server) has already
...
export async function handleLifecycleRequest(
	...
	const baseAudit = {
		...
		chatRef: auditRedactionRef(deps.auditRedactionKey, "skc.lifecycle.audit.v2.chat\0", frame.chatId),
		updateId: frame.updateId,
		requestRef: auditRedactionRef(deps.auditRedactionKey, "skc.lifecycle.audit.v2.request\0", canonicalRequestBytes),
		verb: frame.type,
		targetKind,
		targetRef: auditRedactionRef(deps.auditRedactionKey, "skc.lifecycle.audit.v2.target\0", canonicalTargetBytes),
	} as const;
