...
import { getWorktreeDir, hashPath, isEnoent, prompt, untilAborted } from "@sayknow-cli/utils";
...
const PR_CHECKOUT_BRANCH_CONFIG = {
	headRef: "skcPrHeadRef",
	url: "skcPrUrl",
	isCrossRepository: "skcPrIsCrossRepository",
	maintainerCanModify: "skcPrMaintainerCanModify",
} as const;
...
const PR_CREATE_BASE_CONFIG_KEYS = ["github.prBase", "gh.prBase", "skc.github.prBase"] as const;
