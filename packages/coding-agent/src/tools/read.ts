...
import { glob, type SummaryResult, summarizeCode } from "@sayknow-cli/natives";
import type { Component } from "@sayknow-cli/tui";
import { Text } from "@sayknow-cli/tui";
import { getRemoteDir, logger, prompt, readImageMetadata, untilAborted } from "@sayknow-cli/utils";
...
export class ReadTool implements AgentTool<typeof readSchema, ReadToolDetails> {
	...
	async execute(
		...
		// Handle internal URLs (agent://, artifact://, memory://, rule://, local://, skc://, issue://, pr://).
