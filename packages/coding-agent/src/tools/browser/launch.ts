 ...
 * credentials are: launching shell plus SKC/user-owned `.env` files, never the
 * project `.env`.
 */
 ...
 * The browser is cached under ~/.skc/puppeteer (getPuppeteerDir).
 */
