...
function createNativeComputerController(): NativeController {
	const natives = require("@sayknow-cli/natives") as { ComputerController?: new () => NativeController };
	if (!natives.ComputerController) {
		throw new ToolError("ComputerController is unavailable in @sayknow-cli/natives.", {
