 ...
 * fast model. Native SKC port of the ghost-text prompt-suggestion behavior
...
import { type Api, type AssistantMessage, completeSimple, type Model } from "@sayknow-cli/ai";
