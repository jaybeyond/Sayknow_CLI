...
/**
 * Read `SKC_NO_WEBP` per-call so runtime toggles take effect.
 ...
 *
 * Set SKC_NO_WEBP to exclude WebP from encoding (llama.cpp STB doesn't decode it).
 *
...
export async function resizeImageBuffer(
	...
	try {
		...
		// WebP usually beats JPEG by 25–35% but is disabled when SKC_NO_WEBP is set
		...
		// unless SKC_NO_WEBP is set (llama.cpp STB incompatibility).
