...
This report records descriptive local exact-edit evidence and the product judgments used to assign GPT-5.6 Sol, Terra, and Luna to SKC's built-in Codex-related model profiles.
...
- Date: 2026-07-11
- SKC provider: local `layofflabs` OpenAI Responses-compatible endpoint
