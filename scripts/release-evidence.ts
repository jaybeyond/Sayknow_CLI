...
export const EXPECTED_EVIDENCE_FILE = "sayknow-release-packages-expected-v1.json";
export const FINAL_EVIDENCE_FILE = "sayknow-release-packages-v1.json";
...
export const PUBLIC_PACKAGE_DEFINITIONS: readonly PublicPackageDefinition[] = [
	{ dir: "packages/agent", name: "@sayknow-cli/agent-core" },
	{ dir: "packages/ai", name: "@sayknow-cli/ai" },
	{ dir: "packages/bridge-client", name: "@sayknow-cli/bridge-client" },
	{ dir: "packages/coding-agent", name: "@sayknow-cli/coding-agent" },
	{ dir: "packages/natives", name: "@sayknow-cli/natives" },
	{ dir: "packages/natives-darwin-arm64", name: "@sayknow-cli/natives-darwin-arm64" },
	{ dir: "packages/natives-darwin-x64", name: "@sayknow-cli/natives-darwin-x64" },
	{ dir: "packages/natives-linux-arm64", name: "@sayknow-cli/natives-linux-arm64" },
	{ dir: "packages/natives-linux-x64", name: "@sayknow-cli/natives-linux-x64" },
	{ dir: "packages/natives-win32-x64", name: "@sayknow-cli/natives-win32-x64" },
	{ dir: "packages/stats", name: "@sayknow-cli/stats" },
	{ dir: "packages/tui", name: "@sayknow-cli/tui" },
	{ dir: "packages/utils", name: "@sayknow-cli/utils" },
	{ dir: "packages/sayknow-cli", name: "sayknow-cli" },
] as const;
...
const ownedInternalPackagePrefixes = ["@sayknow-cli/", "@sayknow-cli-sync-sandbox/"] as const;
...
export function assertStableFinalization(input: StableFinalizationInput): void {
	...
	if (input.tag !== `v${input.version}` && input.tag !== `sayknow-v${input.version}`) fail("stable finalization tag must be the exact vX.Y.Z tag or sayknow-v equivalent");
...
export function createGoldenReleaseEvidence(): GoldenReleaseEvidence {
	...
	const packages = PUBLIC_PACKAGE_DEFINITIONS.map(definition => {
		const manifest = JSON.stringify({
			...
			...(definition.name === "@sayknow-cli/coding-agent"
				? { devDependencies: { "@sayknow-cli/ai": releaseVersion } }
				: {}),
		});
