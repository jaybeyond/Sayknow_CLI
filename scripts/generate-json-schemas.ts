...
function createConfigJsonSchema(): JsonSchemaObject {
	const root: JsonSchemaObject = {
		...
		$id: "https://sayknow.ai/schemas/config.schema.json",
		title: "SKC config.yml",
		description: "User and project settings for SKC. Generated from packages/coding-agent/src/config/settings-schema.ts.",
		type: "object",
		properties: {},
...
function createModelsJsonSchema(): JsonSchemaObject {
	return {
		$schema: DRAFT_2020_12,
		$id: "https://sayknow.ai/schemas/models.schema.json",
		title: "SKC models.yml",
		description: "Custom provider and model configuration for SKC. Generated from packages/coding-agent/src/config/models-config-schema.ts.",
...
function settingDefinitionToJsonSchema(settingPath: string, definition: SettingDefinition): JsonSchemaObject {
	...
	if (settingPath === "skc.deepInterview.ambiguityThreshold") {
