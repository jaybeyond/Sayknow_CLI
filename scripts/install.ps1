# SKC Coding Agent Installer for Windows
# Usage: irm https://raw.githubusercontent.com/jaybeyond/sayknow-cli/main/scripts/install.ps1 | iex
#
# Or with options:
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/jaybeyond/sayknow-cli/main/scripts/install.ps1))) -Source
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/jaybeyond/sayknow-cli/main/scripts/install.ps1))) -Binary
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/jaybeyond/sayknow-cli/main/scripts/install.ps1))) -Source -Ref v3.20.1
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/jaybeyond/sayknow-cli/main/scripts/install.ps1))) -Source -Ref main
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/jaybeyond/sayknow-cli/main/scripts/install.ps1))) -Binary -Ref v3.20.1
...
function Configure-BashShell {
    try {
        $settingsDir = Join-Path $env:USERPROFILE ".skc\agent"
        ...
        if ($bashPath) {
            ...
            Write-Host "  SKC requires a bash shell on Windows. Options:" -ForegroundColor Yellow
...
function Install-ViaBun {
    ...
    if ($Ref) {
        ...
        $tmpRoot = Join-Path ([System.IO.Path]::GetTempPath()) ("skc-install-" + [System.Guid]::NewGuid().ToString("N"))
    ...
    Write-Host ""
    Write-Host "✓ Installed skc via bun" -ForegroundColor Green
