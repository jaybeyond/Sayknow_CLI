...
// `@sayknow-cli/natives`, because those fail inside Bun standalone `$bunfs`.
...
const targets: BinaryTarget[] = [
	...
	},
	{
		...
		outfile: "packages/coding-agent/binaries/skc-linux-x64",
	},
	{
		id: "linux-arm64",
		platform: "linux",
		...
		outfile: "packages/coding-agent/binaries/skc-linux-arm64",
	},
	{
		id: "win32-x64",
		platform: "win32",
		...
		outfile: "packages/coding-agent/binaries/skc-windows-x64.exe",
	},
];
